      ...
      <div className="bg-white">
        ...
        <section className="text-center py-12 px-4">
          ...
          <p className="mt-4 text-gray-700 max-w-2xl mx-auto">
            To empower businesses by providing cutting-edge industrial automation solutions that enhance productivity, efficiency, and profitability. We strive to be a trusted partner in our clients’ journey towards success, delivering unparalleled quality and service in every aspect of our operations.        </p>
